...
class PPOUpdater(BaseUpdater):
    def get_test_prompts(self, subgoals, template_test):
        ...
        if template_test == 1:
            ...
            templated_prompts = [
                ' \n Goal of the agent: go to the purple key \n Observation 0: You see a wall 2 steps left, You see a green box 1 step forward, You see a blue ball 3 steps right, \n Action 0: turn left \n Observation 1: You see a wall 3 steps left, You see a red ball 2 steps left and 5 steps forward, You see a blue key 2 steps left and 4 steps forward, You see a grey ball 1 step left and 1 step forward, You see a blue box 3 steps forward, You see a blue ball 1 step right and 1 step forward, You see a green box 2 steps right and 4 steps forward, You see a red ball 2 steps right, You see a purple key 3 steps right and 3 steps forward, \n Action 1: go forward \n Observation 2: You see a red ball 2 steps left and 4 steps forward, You see a blue key 2 steps left and 3 steps forward, You see a grey ball 1 step left, You see a blue box 2 steps forward, You see a blue ball 1 step right, You see a green box 2 steps right and 3 steps forward, You see a purple key 3 steps right and 2 steps forward, \n Action 2: ',
                ' \n Goal of the agent: go to the grey key \n Observation 0: You see a wall 3 steps right, You see a grey box 2 steps left, You see a purple box 1 step left, You see a grey box 1 step forward, You see a grey ball 2 steps right and 1 step forward, \n Action 0: turn right \n Observation 1: You see a wall 1 step left, You see a grey box 4 steps forward, You see a red ball 3 steps forward, You see a red ball 2 steps forward, You see a grey key 2 steps right and 3 steps forward, You see a grey box 3 steps right and 4 steps forward, You see a green ball 3 steps right and 1 step forward, \n Action 1: ',
                ' \n Goal of the agent: go to the green ball \n Observation 0: You see a wall 3 steps left, You see a green box 2 steps left and 1 step forward, You see a yellow box 1 step forward, You see a purple box 1 step right and 1 step forward, \n Action 0: ',
                ' \n Goal of the agent: go to the yellow ball \n Observation 0: You see a blue ball 3 steps left and 2 steps forward, You see a grey box 2 steps left and 2 steps forward, You see a grey key 2 steps left and 1 step forward, You see a purple key 2 steps forward, You see a green box 1 step right, You see a yellow ball 2 steps right and 1 step forward, You see a red box 2 steps right, \n Action 0: go forward \n Observation 1: You see a blue ball 3 steps left and 1 step forward, You see a grey box 2 steps left and 1 step forward, You see a grey key 2 steps left, You see a purple key 1 step forward, You see a yellow ball 2 steps right, \n Action 1: turn right \n Observation 2: You see a purple key 1 step left, You see a yellow ball 2 steps forward, You see a red box 1 step right and 2 steps forward, You see a green box 1 step right and 1 step forward, \n Action 2: ',
                ' \n Goal of the agent: go to the green key \n Observation 0: You see a wall 2 steps left, You see a yellow box 1 step left and 1 step forward, You see a yellow ball 1 step forward, You see a purple box 1 step right and 1 step forward, You see a green ball 2 steps right and 2 steps forward, \n Action 0: ',
                ' \n Goal of the agent: go to the grey key \n Observation 0: You see a red box 1 step left and 2 steps forward, You see a red ball 1 step left, You see a purple ball 1 step forward, You see a grey box 2 steps right and 2 steps forward, You see a blue key 2 steps right and 1 step forward, You see a green ball 3 steps right and 1 step forward, \n Action 0: turn right \n Observation 1: You see a wall 3 steps forward, You see a wall 2 steps left, You see a blue ball 1 step left and 2 steps forward, You see a yellow ball 2 steps right and 2 steps forward, You see a grey box 2 steps right and 1 step forward, You see a green box 2 steps right, You see a grey key 3 steps right, \n Action 1: turn right \n Observation 2: You see a wall 3 steps left, You see a grey box 2 steps left and 4 steps forward, You see a yellow ball 2 steps left and 2 steps forward, You see a grey box 1 step left and 2 steps forward, You see a grey key 3 steps forward, You see a green box 2 steps forward, You see a green ball 1 step right and 2 steps forward, You see a yellow box 2 steps right and 2 steps forward, \n Action 2: ',
                ' \n Goal of the agent: go to the purple box \n Observation 0: You see a wall 1 step left, You see a purple ball 1 step forward, You see a blue key 3 steps right, \n Action 0: turn left \n Observation 1: You see a wall 6 steps forward, You see a wall 1 step right, You see a blue key 3 steps left and 5 steps forward, You see a blue ball 3 steps left and 2 steps forward, You see a purple box 2 steps left and 2 steps forward, You see a yellow ball 1 step left and 4 steps forward, \n Action 1: ',
                ' \n Goal of the agent: go to the blue box \n Observation 0: You see a wall 2 steps right, You see a red box 3 steps left and 4 steps forward, You see a red box 3 steps left and 1 step forward, You see a yellow key 2 steps left and 2 steps forward, You see a red ball 1 step left and 4 steps forward, You see a blue key 1 step left and 3 steps forward, You see a blue box 1 step left and 2 steps forward, You see a yellow ball 1 step left and 1 step forward, You see a grey ball 3 steps forward, \n Action 0: go forward \n Observation 1: You see a wall 2 steps right, You see a red box 3 steps left and 3 steps forward, You see a red box 3 steps left, You see a yellow key 2 steps left and 1 step forward, You see a red ball 1 step left and 3 steps forward, You see a blue key 1 step left and 2 steps forward, You see a blue box 1 step left and 1 step forward, You see a yellow ball 1 step left, You see a grey ball 2 steps forward, \n Action 1: go forward \n Observation 2: You see a wall 2 steps right, You see a red box 3 steps left and 2 steps forward, You see a yellow key 2 steps left, You see a red ball 1 step left and 2 steps forward, You see a blue key 1 step left and 1 step forward, You see a blue box 1 step left, You see a grey ball 1 step forward, \n Action 2: ',
                ' \n Goal of the agent: go to the blue key \n Observation 0: You see a wall 1 step left, You see a purple key 1 step forward, You see a grey box 1 step right and 1 step forward, You see a purple key 2 steps right and 4 steps forward, You see a yellow key 3 steps right and 4 steps forward, You see a blue ball 3 steps right and 3 steps forward, \n Action 0: go forward \n Observation 1: You see a wall 3 steps left, You see a blue key 2 steps left and 3 steps forward, You see a purple box 1 step left and 3 steps forward, You see a green box 1 step left and 2 steps forward, You see a red key 1 step left and 1 step forward, You see a grey box 1 step forward, \n Action 1: turn left \n Observation 2: You see a wall 3 steps forward, You see a wall 3 steps left, You see a yellow key 1 step left and 2 steps forward, You see a red key 1 step right and 1 step forward, You see a grey box 1 step right, You see a green box 2 steps right and 1 step forward, You see a blue key 3 steps right and 2 steps forward, You see a purple box 3 steps right and 1 step forward, \n Action 2: ',
                ' \n Goal of the agent: go to the grey ball \n Observation 0: You see a wall 1 step forward, You see a wall 1 step right, You see a grey ball 3 steps left, \n Action 0: turn left \n Observation 1: You see a wall 1 step right, You see a yellow box 3 steps left and 5 steps forward, You see a purple box 3 steps left and 4 steps forward, You see a green box 1 step left and 3 steps forward, You see a green key 1 step left and 1 step forward, You see a grey ball 3 steps forward, \n Action 1: go forward \n Observation 2: You see a wall 1 step right, You see a yellow box 3 steps left and 4 steps forward, You see a purple box 3 steps left and 3 steps forward, You see a green box 1 step left and 2 steps forward, You see a green key 1 step left, You see a grey ball 2 steps forward, \n Action 2: ',
                ' \n Goal of the agent: go to the green key \n Observation 0: You see a wall 3 steps left, You see a blue ball 2 steps left and 2 steps forward, You see a grey box 3 steps forward, You see a purple ball 2 steps forward, You see a blue key 1 step forward, You see a purple key 1 step right and 3 steps forward, You see a purple ball 2 steps right and 1 step forward, \n Action 0: ',
                ]
